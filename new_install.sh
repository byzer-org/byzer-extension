...
scp ${EXTENSION_HOME}/${MODULE}/target/${MODULE}-${SPARK}_${SCALA}-${VERSION}.jar ${REMOTE_SERVER}:/home/winubuntu/softwares/byzer-lang-all-in-one-linux-amd64-3.3.0-2.3.9/plugin/
